...
\* BEGIN TRANSLATION
\* Label Transfer of process Transfer at line 16 col 5 changed to Transfer_
...
A(self) == /\ pc[self] = "A"
           ...
           /\ pc' = [pc EXCEPT ![self] = "B"]
           /\ UNCHANGED << bob_account, account_total, money >>

B(self) == /\ pc[self] = "B"
           /\ bob_account' = bob_account + money[self]
           /\ pc' = [pc EXCEPT ![self] = "C"]
           /\ UNCHANGED << alice_account, account_total, money >>

C(self) == /\ pc[self] = "C"
           /\ Assert(alice_account >= 0, 
                     "Failure of assertion at line 20, column 4.")
           /\ pc' = [pc EXCEPT ![self] = "Done"]
           /\ UNCHANGED << alice_account, bob_account, account_total, money >>

Transfer(self) == Transfer_(self) \/ A(self) \/ B(self) \/ C(self)
...
\* Last modified Mon Mar 01 12:23:59 CET 2021 by User
